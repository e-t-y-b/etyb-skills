...
name: etyb-review
description: 'Independent two-stage review of the current diff or PR: spec conformance,
  then correctness, security, tests, and quality findings with evidence. Triggers:
  review this diff or PR, pre-merge check.'
license: MIT
