...
description: >
  Mobile architecture expert specialized in designing and building mobile applications
  across React Native/Expo, Flutter/Dart, iOS native (Swift/SwiftUI), and Android native
  (Kotlin/Jetpack Compose), with deep expertise in mobile performance optimization,
  offline-first patterns, and cross-platform strategy. Use this skill whenever the user is
  building a mobile app, designing mobile architecture, choosing a mobile framework, optimizing
  mobile performance, implementing offline-first patterns, or making decisions about native vs
  cross-platform approaches. Trigger when the user mentions "mobile app", "React Native",
  "Expo", "Flutter", "Dart", "iOS", "Swift", "SwiftUI", "UIKit", "Android", "Kotlin",
  "Jetpack Compose", "native app", "cross-platform", "hybrid app", "mobile architecture",
  "app performance", "app size", "startup time", "mobile navigation", "deep linking",
  "push notifications", "App Store", "Play Store", "TestFlight", "EAS Build", "Expo Router",
  "React Navigation", "Hermes", "Fabric", "TurboModules", "New Architecture", "Impeller",
  "Riverpod", "Bloc", "SwiftData", "Core Data", "Room", "Hilt", "mobile testing", "Detox",
  "Maestro", "XCTest", "Espresso", "mobile CI/CD", "Fastlane", "CodePush", "OTA updates",
  "app bundle", "APK", "IPA", "widget", "app extension", "background processing",
  "offline-first", "local-first", "mobile security", "certificate pinning", "biometrics",
  "NativeWind", "Tamagui", "Reanimated", "Skia", "FlashList", "Material You",
  "Cupertino", "adaptive layout", "responsive mobile", "mobile state management",
  "mobile networking", "mobile storage", "SQLite", "MMKV", "WatermelonDB", "Realm",
  "mobile animation", "Lottie", "Rive", "mobile accessibility", "VoiceOver", "TalkBack",
  "Dynamic Type", "mobile monetization", "in-app purchase", "StoreKit", "Google Play Billing",
  "KMP", "Kotlin Multiplatform", "Compose Multiplatform", "universal app", "Expo modules",
  "platform channels", "JSI", "FFI", "mobile DevTools", "Flipper", "Xcode Instruments",
  "Android Profiler", "battery optimization", "memory leak", "jank", "60fps",
  "mobile deployment", "app review", "app signing", "ProGuard", "R8", "Baseline Profiles",
  "Firebase", "Crashlytics", "Analytics", "Remote Config", "mobile monitoring",
  "Sentry mobile", or any question about how to architect, build, optimize, test, deploy,
  or scale a mobile application. Also trigger when the user is choosing between React Native,
  Flutter, iOS native, or Android native, or needs guidance on mobile-specific concerns like
  app store compliance, performance optimization, offline support, or cross-platform strategy.
---
