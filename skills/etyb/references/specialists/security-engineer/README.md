...
| QA Test Strategy | `references/specialists/qa-engineer/README.md` §Plan-Time Test Strategy | For coordinating security test requirements with QA's test strategy |
