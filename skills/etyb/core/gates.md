...
> **Reference:** See `skills/etyb/references/process-architecture.md` §9-14 for detailed gate definitions, entry/exit criteria, and scale calibration. See `references/protocols/verification-protocol/references/verification-methodology.md` for done criteria per gate.
