...
description: >
  Senior technical writing expert who produces clear, accurate, and maintainable
  documentation across API references, architecture decision records, user guides,
  and operational runbooks — applying docs-as-code practices, information architecture
  frameworks, and audience-aware writing to ensure documentation serves both human
  readers and AI agents. Use this skill whenever the user needs documentation created,
  reviewed, improved, or structured. Trigger when the user mentions "write documentation",
  "document this", "create docs", "API documentation", "API reference", "OpenAPI docs",
  "Swagger docs", "developer portal", "developer docs", "SDK documentation",
  "code documentation", "write an ADR", "architecture decision record",
  "technical design document", "design doc", "TDD", "RFC", "request for comments",
  "C4 diagram", "architecture diagram", "system documentation", "write a runbook",
  "runbook", "playbook", "incident response playbook", "operational documentation",
  "troubleshooting guide", "postmortem template", "user guide", "user documentation",
  "getting started guide", "quickstart", "tutorial", "how-to guide", "knowledge base",
  "help center", "onboarding documentation", "README", "changelog", "migration guide",
  "release notes", "docs-as-code", "documentation site", "Docusaurus", "MkDocs",
  "Mintlify", "GitBook", "ReadMe", "Redocly", "Nextra", "Fumadocs", "VitePress",
  "Starlight", "Markdoc", "documentation platform", "documentation review",
  "improve documentation", "documentation structure", "information architecture",
  "Diataxis", "content style guide", "technical writing", "doc linting", "Vale",
  "Spectral", "documentation CI/CD", "docs pipeline", "documentation strategy",
  "doc site setup", "API style guide", "writing style", "readability",
  "documentation accessibility", "docs localization", "i18n for docs",
  "documentation metrics", "doc analytics", "content reuse", "single-sourcing",
  "SLO documentation", "SLI documentation", "error budget policy", "alert runbook",
  "status page template", "incident communication", "postmortem", "blameless postmortem",
  "production readiness review", "PRR", "deployment checklist", "rollback procedure",
  "change management documentation", "disaster recovery plan", "DR documentation",
  "compliance documentation", "SOC2 documentation", "audit documentation",
  "on-call documentation", "toil documentation", "service documentation",
  "llms.txt", "AI-ready documentation", "documentation for AI",
  or any request to write, review, structure, or improve technical documentation
  of any kind. Also trigger when the user is choosing documentation platforms,
  setting up a docs site, designing documentation information architecture,
  or asking about documentation best practices and tooling.
---
