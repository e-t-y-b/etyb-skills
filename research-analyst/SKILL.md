...
description: >
  Research and discovery expert specialized in technology evaluation (framework/library/cloud service
  comparison, weighted scoring matrices, proof-of-concept design, TCO analysis, technology radar
  maintenance, vendor assessment, open-source health metrics, migration cost estimation),
  competitive analysis (competitor tech stack reverse-engineering, feature comparison matrices,
  market positioning, API/DX benchmarking, pricing model analysis, technical differentiation,
  competitive threat scoring, public technical intelligence from blogs/talks/job postings),
  feasibility analysis (technical feasibility assessment, risk identification with FMEA/risk matrices,
  complexity estimation, spike/prototype design, build-vs-buy decisions, constraint analysis,
  scalability assessment, integration feasibility, team capability gap analysis, go/no-go frameworks),
  and requirements analysis (BRD-to-TRD translation, user story mapping, story slicing, requirements
  elicitation, edge case identification, non-functional requirements specification with ISO 25010/FURPS+,
  acceptance criteria patterns, domain-driven design for requirements, API contract requirements,
  requirements validation and verification). Use this skill whenever the user needs to evaluate
  technologies before building, compare frameworks or libraries, assess whether an approach is
  technically feasible, translate business requirements into technical specifications, do pre-development
  research, investigate a new technology, analyze competitors, estimate project complexity, identify
  risks, or make any "should we use X?" or "can we build Y?" decision. Trigger when the user mentions
  "evaluate", "compare", "comparison", "which framework", "which library", "should we use",
  "technology selection", "tech stack", "technology radar", "proof of concept", "PoC", "spike",
  "prototype", "benchmark", "TCO", "total cost of ownership", "vendor evaluation", "vendor lock-in",
  "open source", "community health", "npm downloads", "GitHub stars", "migration cost", "ADR",
  "architecture decision record", "RFC", "competitive analysis", "competitor", "market research",
  "tech stack analysis", "reverse engineer", "feature comparison", "market positioning", "pricing
  analysis", "competitive intelligence", "feasibility", "feasible", "risk assessment", "risk analysis",
  "complexity estimation", "build vs buy", "build or buy", "make vs buy", "constraint analysis",
  "scalability assessment", "go/no-go", "technical risk", "integration feasibility", "capability gap",
  "requirements", "BRD", "business requirements", "TRD", "technical requirements", "user story",
  "story mapping", "story slicing", "requirements elicitation", "edge cases", "non-functional
  requirements", "NFR", "acceptance criteria", "Given-When-Then", "domain modeling", "event storming",
  "bounded context", "ubiquitous language", "requirements traceability", "INVEST criteria",
  "FURPS+", "ISO 25010", "quality attributes", "what should we build", "what technology",
  "research phase", "discovery phase", "due diligence", "technical due diligence", "evaluation
  matrix", "scoring matrix", "weighted criteria", "decision matrix", "tradeoff analysis",
  "tradeoff matrix", "pros and cons", "alternatives analysis", "options analysis", "technology
  assessment", "technical assessment", "landscape analysis", "market landscape", "tool selection",
  "tool evaluation", "framework selection", "library selection", "cloud service comparison",
  "AWS vs GCP vs Azure", "React vs Vue vs Svelte", "PostgreSQL vs MySQL", "Kafka vs RabbitMQ",
  "REST vs GraphQL vs gRPC", "monolith vs microservices", "serverless vs containers",
  or any question about researching, evaluating, comparing, or selecting technologies,
  analyzing competitors, assessing feasibility, or engineering requirements before development begins.
  Also trigger when the user is in the early stages of a project and needs to make foundational
  technology or architecture decisions, or when they need to justify a technical choice to stakeholders.
---
