...
name: ai-ml-engineer
description: >
  AI/ML engineering expert specialized in machine learning model development, MLOps,
  LLM/GenAI systems, data science, and AI product integration, with deep expertise
  across PyTorch, JAX, scikit-learn, HuggingFace, and the modern ML stack. Use this
  skill whenever the user is building ML models, designing ML pipelines, choosing ML
  frameworks, implementing LLM-powered features, building RAG systems, setting up
  experiment tracking, deploying models to production, designing recommendation systems,
  running A/B tests, performing statistical analysis, integrating AI into products,
  optimizing inference latency, managing ML costs, or asking about ML/AI architecture
  patterns. Trigger when the user mentions "machine learning", "ML", "deep learning",
  "neural network", "model training", "model serving", "inference", "MLOps",
  "ML pipeline", "experiment tracking", "feature engineering", "feature store",
  "model registry", "model monitoring", "data drift", "concept drift", "LLM",
  "large language model", "GenAI", "generative AI", "prompt engineering", "RAG",
  "retrieval-augmented generation", "vector database", "embeddings", "fine-tuning",
  "LoRA", "QLoRA", "PEFT", "RLHF", "DPO", "AI agent", "tool use", "function calling",
  "data science", "A/B testing", "statistical analysis", "experimentation",
  "recommendation system", "time series", "forecasting", "NLP", "computer vision",
  "PyTorch", "TensorFlow", "JAX", "scikit-learn", "XGBoost", "LightGBM",
  "HuggingFace", "transformers", "diffusers", "MLflow", "Weights & Biases", "W&B",
  "Kubeflow", "Ray", "vLLM", "Triton", "TorchServe", "BentoML", "ONNX",
  "TensorRT", "quantization", "distillation", "pruning", "Pinecone", "Weaviate",
  "Qdrant", "Milvus", "Chroma", "pgvector", "LangChain", "LangGraph",
  "Claude API", "OpenAI API", "Anthropic SDK", "Vercel AI SDK", "LangSmith",
  "Langfuse", "semantic caching", "model routing", "AI safety", "AI ethics",
  "bias detection", "fairness", "explainability", "SHAP", "LIME", "Captum",
  "AutoML", "hyperparameter tuning", "Optuna", "distributed training", "DeepSpeed",
  "FSDP", "model parallelism", "data parallelism", "GPU", "CUDA", "streaming AI",
  "AI UX", "AI cost optimization", "token optimization", "prompt caching",
  "AI observability", "EU AI Act", "AI compliance", or any question about how to
  build, train, deploy, evaluate, or integrate AI/ML systems into products. Also
  trigger when the user is choosing between ML approaches, evaluating model performance,
  designing data pipelines for ML, or architecting AI-powered product features.
---
