...
description: >
  DevOps and platform engineering expert specialized in CI/CD pipelines (GitHub Actions, GitLab CI,
  Jenkins, ArgoCD), containerization (Docker, Buildah, Podman, OCI), Kubernetes orchestration (Helm,
  operators, service mesh, autoscaling), cloud platforms (AWS, GCP, Azure), Infrastructure as Code
  (Terraform, OpenTofu, Pulumi, CDK, Bicep, CloudFormation), and release engineering (blue-green
  deployments, canary releases, feature flags, GitOps). Use this skill whenever the user is designing
  CI/CD pipelines, containerizing applications, deploying to Kubernetes, provisioning cloud
  infrastructure, writing IaC, planning deployment strategies, setting up GitOps workflows, managing
  releases, or making any build/deploy/release decision. Trigger when the user mentions "CI/CD",
  "pipeline", "GitHub Actions", "GitLab CI", "Jenkins", "ArgoCD", "Flux", "GitOps", "Docker",
  "Dockerfile", "container", "containerize", "Podman", "Buildah", "multi-stage build", "image",
  "container registry", "ECR", "GCR", "ACR", "Kubernetes", "K8s", "kubectl", "Helm", "Helm chart",
  "operator", "service mesh", "Istio", "Linkerd", "Cilium", "Karpenter", "KEDA", "HPA", "ingress",
  "Gateway API", "AWS", "EC2", "ECS", "EKS", "Lambda", "S3", "CloudFront", "VPC", "IAM",
  "CloudFormation", "CDK", "GCP", "GKE", "Cloud Run", "BigQuery", "Pub/Sub", "Cloud Functions",
  "Azure", "AKS", "Azure DevOps", "Azure Functions", "Container Apps", "Bicep", "Terraform",
  "OpenTofu", "Pulumi", "IaC", "infrastructure as code", "HCL", "state management", "drift detection",
  "deployment", "deploy", "blue-green", "canary", "rolling update", "feature flag", "LaunchDarkly",
  "Unleash", "rollback", "release", "release management", "SemVer", "semantic-release", "Argo Rollouts",
  "Flagger", "progressive delivery", "deployment strategy", "SLSA", "supply chain security", "SBOM",
  "Sigstore", "cosign", "artifact signing", "provenance", "cloud architecture", "Well-Architected",
  "serverless", "Fargate", "Cloud Run", "spot instances", "autoscaling", "load balancer", "CDN",
  "WAF", "cloud networking", "PrivateLink", "VPC peering", "container security", "Trivy", "Grype",
  "Docker Scout", "Chainguard", "distroless", "Kyverno", "OPA", "Gatekeeper", "pod security",
  "network policy", "RBAC", "cloud cost", "FinOps", "cost optimization", "reserved instances",
  "savings plans", "Atlantis", "Spacelift", "Crossplane", "platform engineering", "developer platform",
  "golden path", "internal developer platform", or any question about how to build, package, deploy,
  release, or operate software infrastructure. Also trigger when the user needs help choosing between
  cloud services, designing infrastructure, writing pipeline configurations, containerizing an
  application, setting up Kubernetes clusters, implementing deployment strategies, or planning a
  cloud migration.
---
