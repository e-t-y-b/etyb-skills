...
description: >
  Meta-protocol for creating, evaluating, and improving etyb skills. Applies TDD to
  documentation — no skill change without a failing eval first. This is the self-improvement
  loop that makes the entire skill system get better over time. Covers the full skill
  lifecycle: identifying gaps, writing failing evals, creating or updating skills, verifying
  no regressions, and accumulating institutional knowledge across sessions. Understands
  skill anatomy (frontmatter, role, golden rule, approach, scale-aware, sub-skills, core
  knowledge, format, process awareness, verification, debugging, boundaries), reference
  anatomy (ToC, deep sections, code examples, tables, checklists), eval anatomy (JSON with
  assertions), and the distinction between process protocols and domain experts. Use this
  skill whenever the user wants to create a new skill, improve an existing skill, write
  evals, understand how skills work, debug a skill that is not performing well, merge or
  split skills, deprecate a skill, design trigger keywords, structure reference files,
  build rationalization tables, or evolve the skill architecture itself. Trigger when the
  user mentions "create skill", "new skill", "improve skill", "skill not working",
  "write skill", "skill engineering", "eval", "evaluation", "skill quality",
  "how do skills work", "skill template", "skill anatomy", "skill format", "skill structure",
  "add a skill", "build a skill", "design a skill", "skill lifecycle", "skill creation",
  "skill improvement", "skill evolution", "skill maintenance", "skill deprecation",
  "merge skills", "split skill", "skill overlap", "skill conflict", "skill scope",
  "skill triggers", "trigger keywords", "skill description", "skill frontmatter",
  "reference file", "reference anatomy", "sub-skill", "eval engineering", "write eval",
  "failing eval", "eval format", "eval assertions", "behavioral check", "content check",
  "eval JSON", "run evals", "eval results", "TDD for docs", "TDD for documentation",
  "documentation TDD", "institutional memory", "cross-session learning", "skill gap",
  "skill feedback", "skill regression", "skill architecture", "meta-protocol",
  "self-improvement", "skill system", "etyb architecture", "etyb skills", "skill directory",
  "process protocol", "domain expert", "rationalization table", "skill naming",
  "skill conventions", "skill checklist", "skill review", "skill audit",
  "improvement loop", "feedback loop", "knowledge accumulation", "memory vs skill",
  or any situation where the skill system itself needs to be created, understood,
