...
description: >
  Senior project planning and delivery expert specialized in sprint planning, technical
  project management, and agile process coaching for software engineering teams — combining
  deep knowledge of estimation techniques, delivery metrics, risk management, and team
  process optimization to help teams ship predictably and sustainably. Use this skill
  whenever the user needs help planning sprints, managing project timelines, improving
  team processes, or coordinating delivery across engineering teams. Trigger when the user
  mentions "sprint planning", "sprint", "backlog", "backlog refinement", "backlog grooming",
  "story points", "estimation", "t-shirt sizing", "velocity", "capacity planning",
  "sprint capacity", "burndown", "burnup", "user stories", "story breakdown", "epic breakdown",
  "acceptance criteria", "definition of done", "sprint review", "sprint goal",
  "project planning", "project timeline", "roadmap", "milestone", "milestone tracking",
  "Gantt chart", "Now/Next/Later", "dependency mapping", "dependencies", "risk register",
  "risk matrix", "RAID log", "stakeholder update", "status report", "RACI matrix",
  "resource allocation", "capacity planning", "project estimation", "PERT estimation",
  "Monte Carlo forecasting", "cone of uncertainty", "earned value management",
  "DORA metrics", "deployment frequency", "lead time", "change failure rate", "MTTR",
  "value stream mapping", "technical debt tracking", "tech debt prioritization",
  "cross-team coordination", "program management", "OKRs", "quarterly planning",
  "agile coaching", "scrum", "scrum master", "kanban", "scrumban", "Shape Up",
  "retrospective", "retro", "sprint retrospective", "team health", "team health check",
  "process improvement", "agile transformation", "agile maturity", "SAFe", "LeSS",
  "Nexus", "agile at scale", "ceremony", "standup", "daily standup", "WIP limits",
  "flow metrics", "cycle time", "throughput", "developer experience", "DevEx",
  "SPACE framework", "engineering productivity", "continuous improvement", "kaizen",
  "Jira", "Linear", "Shortcut", "Asana", "Monday.com", "ClickUp", "GitHub Projects",
  "Notion projects", "agile anti-patterns", "zombie scrum", "cargo cult agile",
  "team topologies", "flight levels", "dual-track agile", "no-estimates",
  or any question about how to plan, estimate, track, deliver, or improve the delivery
  process for software engineering projects. Also trigger when the user is choosing
  between agile methodologies, setting up team processes, running retrospectives,
  planning capacity across teams, managing cross-team dependencies, or asking about
