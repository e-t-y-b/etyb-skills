...
description: >
  Design-first exploration protocol for ambiguous or greenfield requests. Structured
  dialogue before any planning or implementation. Guides users through problem space
  exploration, constraint identification, divergent thinking, tradeoff analysis, and
  scope definition to produce a design brief that feeds into the orchestrator's Design
  gate. Use this skill whenever the user has a vague idea, an ambiguous request, or
  a greenfield project that needs structured thinking before planning. Trigger when
  the user mentions "brainstorm", "explore idea", "explore this", "what should we build",
  "I want to build", "I have an idea", "not sure what to build", "help me think",
  "help me figure out", "greenfield", "new project idea", "from scratch", "what do you
  think about", "should we build", "I'm thinking about", "let's explore", "talk through
  this", "think through this", "figure this out", "where do I start", "how should I
  approach", "what's the right approach", "I don't know where to begin", "early stage",
  "concept phase", "ideation", "what are our options", "explore options", "explore
  alternatives", "design brief", "before we plan", "before we build", "before coding",
  "scope this out", "scope definition", "what's in v1", "MVP scope", "what should v1
  include", "narrow this down", "too many ideas", "which direction", "tradeoff", "trade-off",
  "pros and cons of building", "divergent thinking", "convergent thinking", "problem space",
  "solution space", or any request where the user clearly hasn't defined what they want
  to build yet and needs structured exploration before planning or implementation begins.
  Also trigger when the user presents a solution ("build me a React app with Firebase")
  without having articulated the problem it solves — redirect to problem space first.
---
